...
module ReservationValidator
  ...
  included do
    ...
    validate :in_the_future, unless: 'admin?'
    validate :no_overlapping_reservations
    validate :not_on_offday
    validate :duration_policy, unless: 'admin?'
    validate :start_time_policy, unless: 'admin?'
    validate :date_limit_policy, unless: 'admin?'
